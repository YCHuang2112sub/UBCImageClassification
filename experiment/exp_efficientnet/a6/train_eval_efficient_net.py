...
def evaluation(model, valid_dataloader, criteria, device):
        ...
        for imgs, labels, imgs_10, imgs_11, imgs_12 in tqdm(valid_dataloader):
            ...
            with torch.no_grad():
                ...
                loss_similarity = criteria(similarity_scores_a00, gt_similarity) +                                     criteria(similarity_scores_a01, gt_similarity) +                                     criteria(similarity_scores_a02, gt_similarity) +                                     criteria(similarity_scores_a03, gt_similarity) +                                     criteria(similarity_scores_a04, gt_similarity) +                                     criteria(similarity_scores_a05, gt_similarity)    
